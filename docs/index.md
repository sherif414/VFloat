...
layout: home
title: VFloat
titleTemplate: Vue 3 floating UI primitives
description: VFloat is a Vue 3 toolkit for positioning and coordinating anchored floating interfaces.
hero:
  name: VFloat
...
features:
  - icon: 🎯
    ...
    details: Use `useFloatingContext` with middlewares like `offset`, `flip`, `shift`, and `size` to keep floating surfaces aligned and in view.
  - icon: 🧩
